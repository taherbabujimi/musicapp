CREATE PROCEDURE music_app.addRole(givenRoleName VARCHAR(255), givenPermissions JSON, givenUserId INT)
    DETERMINISTIC
BEGIN
	CALL verifyUsertypeAndPermission(givenUserId, '["superAdmin"]', NULL);
